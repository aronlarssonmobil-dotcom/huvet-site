    ...
    <>
      ...
      <main style={{ maxWidth: '860px', margin: '0 auto', padding: '2rem 1.25rem 4rem', color: '#0d1f17' }}>
        <nav style={{ fontSize: '0.8rem', color: '#555', marginBottom: '1.5rem' }}>
          <Link href="/" style={{ color: '#006B3F', textDecoration: 'none' }}>Huvet</Link> › <Link href="/ovningsprov" style={{ color: '#006B3F', textDecoration: 'none' }}>Övningsprov</Link> › Guide
        </nav>
        ...
        <div style={{ background: '#e6f4ee', borderRadius: '12px', padding: '1.25rem 1.5rem', marginBottom: '2.5rem' }}>
          <strong style={{ color: '#006B3F' }}>📊 Snabbfakta om teoriprovet</strong>
        ...
        <h2 style={{ color: '#006B3F', borderBottom: '2px solid #e6f4ee', paddingBottom: '0.5rem' }}>Hur teoriprovet är uppbyggt</h2>
        ...
        <h2 style={{ color: '#006B3F', borderBottom: '2px solid #e6f4ee', paddingBottom: '0.5rem' }}>7 strategier för att klara övningsprovet</h2>
        <ol style={{ lineHeight: 2, paddingLeft: '1.5rem', color: '#333' }}>
        ...
        <h2 style={{ color: '#006B3F', borderBottom: '2px solid #e6f4ee', paddingBottom: '0.5rem' }}>Vanligaste fällan på teoriprovet</h2>
        ...
        <h2 style={{ color: '#006B3F', borderBottom: '2px solid #e6f4ee', paddingBottom: '0.5rem' }}>När är du redo att boka provet?</h2>
        <p style={{ lineHeight: 1.8, color: '#333' }}>
        ...
        <div style={{ background: '#e6f4ee', borderRadius: '12px', padding: '1.5rem', marginTop: '2rem' }}>
          <h3 style={{ marginTop: 0, color: '#006B3F' }}>Gör ett gratis övningsprov nu</h3>
        ...
        <nav style={{ marginTop: '2.5rem', paddingTop: '1.5rem', borderTop: '1px solid #e6f4ee', display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
          <Link href="/hastighetsgranser-guide" style={{ color: '#006B3F', textDecoration: 'none' }}>← Hastighetsgränser guide</Link>
          <Link href="/korkort-kostnad-guide" style={{ color: '#006B3F', textDecoration: 'none', marginLeft: 'auto' }}>Körkort kostnad →</Link>
        </nav>
