    ...
    <div style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", background: '#fff', minHeight: '100vh', color: '#0d1f17' }}>
      ...
      <section style={{ background: '#fff', padding: '0 20px 80px' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
            ...
            <div key={m.number} style={{
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px' }}>
                <div style={{
                  ...
                  background: m.severity === 'critical' ? '#006B3F' : '#f0f7f3',
                  color: m.severity === 'critical' ? 'white' : '#006B3F',
                  borderRadius: '12px',
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ background: '#e6f4ee', borderRadius: '12px', padding: '14px 18px', display: 'flex', gap: '10px', alignItems: 'flex-start' }}>
                    ...
                    <p style={{ fontSize: '14px', lineHeight: '1.6', color: '#004d2d', margin: 0, fontWeight: '500' }}>
                      {m.tip}
                    </p>
                  </div>
                </div>
          ...
          {/* CTA block */}
          <div style={{ background: 'linear-gradient(135deg, #006B3F 0%, #004d2d 100%)', borderRadius: '24px', padding: '40px', textAlign: 'center', color: 'white', marginTop: '48px' }}>
